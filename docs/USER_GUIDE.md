...
|---|---|---|
| **Public registration** | https://relkady84.github.io/Batroun-Race/ | Runners — anyone signing up |
| **Admin dashboard** | https://relkady84.github.io/Batroun-Race/admin.html | Admins + staff — must sign in with Google (use Chrome) |
| **Race-day scanner** | https://relkady84.github.io/Batroun-Race/scan.html | Hostesses on race day — same Google sign-in |
...
1. Sign in to https://relkady84.github.io/Batroun-Race/admin.html (Chrome only)
...
The day of the race, open https://relkady84.github.io/Batroun-Race/scan.html on a phone (Chrome or Safari).
